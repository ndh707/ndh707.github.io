...
const PRODUCTS = [
  ...
  { id: 21, name: "Glass Skin Starter Set", brand: "HARU CURATED", price: 54.99, category: "gift-box", badge: "Limited", rating: 4.9, reviews: 420, desc: "5-step routine set: cleanser, toner, essence, serum & moisturizer. Curated from our best sellers.", sizes: ["Standard"] },
  { id: 22, name: "Mystery Beauty Box", brand: "HARU CURATED", price: 39.99, category: "gift-box", badge: "Mystery", rating: 4.8, reviews: 890, desc: "6+ full-size K-beauty products worth over $80. Every box is a surprise!", sizes: ["Standard"] },
  { id: 23, name: "Seoul Snack Box", brand: "HARU CURATED", price: 29.99, category: "gift-box", badge: "Popular", rating: 4.9, reviews: 1560, desc: "10+ Korean snacks & treats in one box: chips, cookies, candy, ramyun, and drinks.", sizes: ["Standard", "XL (20+ items)"] },
  { id: 24, name: "K-Beauty + Snacks Duo Box", brand: "HARU CURATED", price: 64.99, category: "gift-box", badge: "Exclusive", rating: 4.9, reviews: 340, desc: "The ultimate gift: 4 skincare favorites + 8 Korean snacks in one box.", sizes: ["Standard"] },
  { id: 25, name: "Summer Glow Limited Edition Box", brand: "HARU CURATED", price: 49.99, category: "gift-box", badge: "Seasonal", rating: 4.7, reviews: 210, desc: "Seasonal summer set: lightweight SPF, mist toner, vitamin serum + cooling aloe gel. Limited run.", sizes: ["Standard"] },
];
